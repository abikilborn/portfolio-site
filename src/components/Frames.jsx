...
export function Collage({ back, front, phone, overlay, label, className = '' }) {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-2xl border border-stone-200 bg-linear-to-br from-blue-50 via-stone-50 to-stone-100 ${className}`}
    >
      ...
      <img src={front.src} alt="" loading="lazy" className={`${shot} right-[4%] top-[18%] w-[58%] shadow-2xl shadow-stone-900/15 transition-transform duration-500 group-hover:-translate-y-2`} />
      {phone && (
